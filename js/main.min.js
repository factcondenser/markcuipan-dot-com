...
$(function() {
    $("a[href*=#]:not([href=#])").click(function() {
        if (location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") || location.hostname == this.hostname) {
            ...
            if (a.length) { $("html,body").animate({ scrollTop: a.offset().top }, 1000); return false }
        }
    })
});
...
$(document).ready(function() {
    var h = { Madison0: "Madison, Wisconsin", Madison1: "Madison, Wisconsin", Hk0: "Hong Kong", Hk1: "Hong Kong", Beijing: "Beijing, China" };
    var a = Object.keys(h);
...
function createsoundbite(d) {
    ...
    if (b.canPlayType) {
        for (var c = 0; c < arguments.length; c++) {
            ...
            if (arguments[c].match(/\.(\w+)$/i)) { a.setAttribute("type", html5_audiotypes[RegExp.$1]) } b.appendChild(a)
        }
        b.load();
        b.playclip = function() {
            b.pause();
        ...
        return b
    } else { return { playclip: function() { throw new Error("Your browser doesn't support HTML5 audio unfortunately") } } }
}
